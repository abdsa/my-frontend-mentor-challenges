  ...
  return (
    <>
      ...
      <main className="grid grid-cols-1 grid-rows-2 place-items-center lg:grid-cols-2 lg:grid-rows-1">
        <div className="relative grid  h-[406px] w-[200px] rounded-[20px] p-[8px] shadow-[9px_20px_40px_1px_rgb(0,0,0,0.1)]">
          ...
          <div className="h-full w-full rounded-[15px] bg-light-grayish-violet-app-background">
            ...
            <div className="grid gap-2 px-[7px] py-3">
              <div className="text-moderate-violet-chat-on-the-left text-[8px] rounded-[10px] rounded-bl-[5px] p-2 bg-[#ECE5F3] max-w-[130px] break-words">
                That sounds great. I&apos;d be happy with that.
              </div>
              <div className="text-moderate-violet-chat-on-the-left text-[8px] rounded-[10px] rounded-bl-[5px] p-2 bg-[#ECE5F3] max-w-[130px] break-words">
                Could you send over some pictures of your dog, please?
              </div>
              <div className="place-self-end text-[8px] rounded-[10px] rounded-bl-[5px] p-2 bg-white max-w-[130px] break-words shadow-lg">
